...
import ExploreCourse from "./pages/user/course/ExploreCourse";
import CourseDetail from "./pages/user/course/CourseDetail";
import { Gallery } from "./pages/admin/Gallery";
import { GalleryView } from "./pages/user/gallery/GalleryView";
import { Group } from "./pages/admin/Group";
import { Team } from "./pages/admin/Team";
import { Clients } from "./pages/admin/Clients";
import { ClientsView } from "./pages/user/partners/ClientsView";
        ...
        <div className="flex-1">
          ...
          <Routes>
            ...
            <Route element={<AdminRoutes />}>
              ...
              />
              <Route
                path="/admin/manage-testimonial"
                element={<AdminLayout children={<Testimonial />} />}
              />
              <Route
