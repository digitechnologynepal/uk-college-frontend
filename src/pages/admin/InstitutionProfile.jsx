                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    {props.errors.whatsapp && props.touched.whatsapp && (
                                        <p className="text-red-500 text-sm">{props.errors.whatsapp}</p>
                                    )}
                                </div>
                                <div className="flex flex-col gap-2">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    {props.errors.linkedin && props.touched.linkedin && (
                                        <p className="text-red-500 text-sm">{props.errors.linkedin}</p>
                                    )}
                                </div>
                                <div className="flex flex-col gap-2">
                                    ...
                                    {props.errors.number && props.touched.number && (
                                        <p className="text-red-500 text-sm">{props.errors.number}</p>
                                    )}
                                </div>

                                <div className="flex flex-col gap-2">
                                    <label htmlFor="insta" className="block font-medium">Instagram</label>
                                    <div className="mt-1">
                                        <Field
                                            type="text"
                                            name="insta"
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="facebook" className="block font-medium">Facebook Link</label>
                                    <div className="mt-1">
                                        <Field
                                            type="text"
                                            name="facebook"
                                    ...
                                    {props.errors.facebook && props.touched.facebook && (
                                        <p className="text-red-500 text-sm">{props.errors.facebook}</p>
                                    )}
                                </div>
                            </div>
